...
(function() {
    $(function() {
        ...
        var option = {
            ...
            // 提示框组件
            tooltip: {
                // trigger 触发方式。非轴图像，使用item 的意思是放到数据对应图形上触发提示
                trigger: 'item',
                // 格式化提示内容：
                // a 代表series 系列图表名称
                // b 代表series 数据名称 data 里面的 name
                // c 代表series 数据值  data 里面的value
                // d 代表series 当前数据/总数据的比例
            ...
            series: [{
                ...
                // 百分比基于 图表DOM容器的半径 第一项是内半径，第二项是外半径
                // 如果 radius 写百分比，则必须加引号
                radius: [10, 70],
